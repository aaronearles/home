...
name: docker
description: >
  Standards and best practices for Docker and Docker Compose development.
  Use this skill whenever writing, reviewing, scaffolding, or refactoring any
  Docker configuration — including docker-compose.yml files, Dockerfiles, container
  networking, volume management, environment/secret management, Traefik reverse proxy
  labels, health checks, or multi-service stacks. Also use when creating new service
  stacks, reviewing for standards compliance, or generating boilerplate/templates.
---
